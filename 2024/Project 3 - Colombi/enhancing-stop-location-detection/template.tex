...
\begin{figure}[ht]
	...
	\caption{This trajectory, derived from GPS data, illustrates a common challenge: density-based algorithms struggle to accurately detect stop locations when confronted with noisy or incomplete data, particularly when temporal and spatial gaps are present. %Our approach bypasses this issue by relying only on features that do not depend on the presence of clusters of points.
 }
